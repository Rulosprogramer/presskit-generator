  ...
  return (
    <footer className="border-t border-white/10 bg-[#0f1624]">
      <div className="mx-auto w-full max-w-400 px-6 py-10 lg:px-12">
        <div className="relative overflow-hidden rounded-4xl border border-white/10 bg-[#1c2635] px-6 py-8 shadow-[0_20px_60px_rgba(0,0,0,0.24)] sm:px-10">
          <div className="absolute inset-x-0 top-1/2 h-px -translate-y-1/2 bg-linear-to-r from-transparent via-[#4d6788] to-transparent opacity-80" />
          <div className="absolute left-1/2 top-1/2 h-5 w-28 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[#32455f] opacity-90" />
          <div className="absolute left-1/2 top-1/2 h-8 w-px -translate-x-24 -translate-y-1/2 bg-[#4d6788]" />
          <div className="absolute left-1/2 top-1/2 h-8 w-px translate-x-24 -translate-y-1/2 bg-[#4d6788]" />

          <div className="relative mx-auto flex max-w-4xl flex-col items-center gap-6 text-center">
            <div className="rounded-none bg-[#ff6d2d] px-6 py-4 shadow-[0_12px_30px_rgba(255,109,45,0.28)] transition hover:scale-[1.02] hover:bg-[#ff7a45]">
              <a
                href="/auth"
                className="block text-sm font-extrabold uppercase tracking-[0.08em] text-white sm:text-base"
              >
                Start Creating
              </a>
            </div>

            <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-sm text-[#d7dde6]">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 text-[#9aa8bb]">
              <a
            ...
            <p className="text-xs uppercase tracking-[0.22em] text-[#9aa8bb]">© {year} Presskit Generator</p>
          </div>
        </div>
      </div>
    </footer>
